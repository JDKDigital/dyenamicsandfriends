...
public class AnotherFurnitureCompat
{
    ...
    public static void registerBlocks(DyenamicDyeColor color) {
        ...
        CURTAINS.put(color, DyenamicRegistry.registerBlock(prefix + "_curtain", () -> new DyenamicsCurtainBlock(color, BlockBehaviour.Properties.of(Material.WOOL, color.getMapColor()).strength(0.1F).sound(SoundType.WOOL).noOcclusion().lightLevel(state -> color.getLightValue())), CreativeModeTab.TAB_MISC, true));
